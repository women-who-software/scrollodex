  ...
  return (
    <div className="rachaelCardContainer">
      <div className="rachaelCard">
        <img
          className="rachaelImageContainer"
          src={image}
          alt="woman hiking in front of the mountains"
        />
      </div>
      ...
      <div className="rachaelCard">
        ...
        <div className="rachaelLinkContainer">
          <a className="rachaelLink" href="https://www.github.com/rachael-t">
            GitHub
          </a>
          <br></br>
          <a
            className="rachaelLink"
            href="https://www.linkedin.com/in/rachael-lenss-thomas"
          >
            LinkedIn
          </a>
        </div>
