  ...
  return (
    <div className="cardContainer">
      ...
      <div className="card">
        ...
        <a href="https://github.com/Kitkatnik/" className="button">
          GitHub
        </a>
        <a href="https://www.polywork.com/kitkatnik" className="button">
          Polywork
        </a>
        <a
          href="https://www.linkedin.com/in/katyasarmiento/"
          className="button"
        >
          LinkedIn
        </a>
